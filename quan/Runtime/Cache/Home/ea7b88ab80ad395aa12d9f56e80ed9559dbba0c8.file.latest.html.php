<?php /* Smarty version Smarty-3.1.6, created on 2012-05-04 14:03:31
         compiled from "D:\APMServ5.2.6\www\htdocs\quan\Tpl\Home\default\Code\latest.html" */ ?>
<?php /*%%SmartyHeaderCode:169324fa37133df7ef5-37634039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea7b88ab80ad395aa12d9f56e80ed9559dbba0c8' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\quan\\Tpl\\Home\\default\\Code\\latest.html',
      1 => 1335945601,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169324fa37133df7ef5-37634039',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_4fa37134bf487',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4fa37134bf487')) {function content_4fa37134bf487($_smarty_tpl) {?><?php if (!is_callable('smarty_function_fixedUrl')) include 'D:\\APMServ5.2.6\\www\\htdocs\\quan\\ThinkPHP\\Extend\\Vendor\\Smarty\\plugins\\function.fixedUrl.php';
            ...
            <div class="main_l">
                <div id="main_l_l" class="clear">
                    ...
                    <dl class="filter clear">
                        ...
                        <dd <?php if ($_smarty_tpl->tpl_vars['cate_id']->value==0){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=0&t_type=".($_smarty_tpl->tpl_vars['t_type']->value)."&cate_id2=0&p=1"),$_smarty_tpl);?>
">全部</a></dd>
...
?>
                        ...
                        <dd <?php if ($_smarty_tpl->tpl_vars['cate_id']->value==$_smarty_tpl->tpl_vars['item']->value['id']){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['item']->value['id'])."&t_type=".($_smarty_tpl->tpl_vars['t_type']->value)."&cate_id2=0&p=1"),$_smarty_tpl);?>
...
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                        <dd <?php if ($_smarty_tpl->tpl_vars['cate_id2']->value==$_smarty_tpl->tpl_vars['item']->value['id']){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=".($_smarty_tpl->tpl_vars['t_type']->value)."&cate_id2=".($_smarty_tpl->tpl_vars['item']->value['id'])."&p=1"),$_smarty_tpl);?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value['name'];?>
</a></dd>
                        <?php } ?>
                    </dl>
                    ...
                    <dl class="filter clear">
                        <dt>发布日期：</dt>
                        <dd <?php if ($_smarty_tpl->tpl_vars['t_type']->value==0){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=0&cate_id2=".($_smarty_tpl->tpl_vars['cate_id2']->value)."&p=1"),$_smarty_tpl);?>
">全部</a></dd><dd <?php if ($_smarty_tpl->tpl_vars['t_type']->value==1){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=1&cate_id2=".($_smarty_tpl->tpl_vars['cate_id2']->value)."&p=1"),$_smarty_tpl);?>
">今天</a></dd><dd <?php if ($_smarty_tpl->tpl_vars['t_type']->value==2){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=2&cate_id2=".($_smarty_tpl->tpl_vars['cate_id2']->value)."&p=1"),$_smarty_tpl);?>
">三天内</a></dd><dd <?php if ($_smarty_tpl->tpl_vars['t_type']->value==3){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=3&cate_id2=".($_smarty_tpl->tpl_vars['cate_id2']->value)."&p=1"),$_smarty_tpl);?>
">一周内</a></dd><dd <?php if ($_smarty_tpl->tpl_vars['t_type']->value==4){?>class="current"<?php }?>><a href="<?php echo smarty_function_fixedUrl(array('url'=>"Code/latest?cate_id=".($_smarty_tpl->tpl_vars['cate_id']->value)."&t_type=4&cate_id2=".($_smarty_tpl->tpl_vars['cate_id2']->value)."&p=1"),$_smarty_tpl);?>
">一月内</a></dd>
                    </dl>
...
<ul class="pager"><?php echo $_smarty_tpl->tpl_vars['pagelink']->value;?>
            ...
            <div class="main_r" style="width: 320px;">
                <ul class="sidebar">
               		<li><script type="text/javascript" src="/index.php?m=Adv&a=show&id=7"></script></li>
                    <li class="gray">
                        <h3>
                            热门优惠券</h3>
                        <ul class="hot_coupon">
