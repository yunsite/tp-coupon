...
function editorInit_html(options)
{
	var plugins={
	...
	return $(options.elm).xheditor({plugins:plugins,tools:options.tools,showBlocktag:false,forcePtag:false,emots:emots,emotMark:true,upImgUrl:options.upscript_url,upImgExt:"jpg,jpeg,gif,png"});
}